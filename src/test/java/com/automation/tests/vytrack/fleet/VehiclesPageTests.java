...
//        driver.findElement(fleetBy).click();
    ...
    public void verifyPageNumber(){
       // driver.findElement(By.xpath("//input[@type=\"number\"]")).getAttribute("value");
        Assert.assertEquals("1",driver.findElement(By.xpath("//input[@type=\"number\"]")).getAttribute("value"));
    }
